						...
						<div className='space-y-6'>
							...
							<div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6'>
								<Card className='p-6 bg-white border-[#5A3E2B]/10'>
									<div className='flex items-center justify-between'>
										<div>
											<p className='text-sm text-[#5A3E2B]/70'>Tổng doanh thu</p>
											<p className='text-2xl font-bold text-[#5A3E2B]'>120.000.000₫</p>
											<p className='text-sm text-[#A5C6A1]'>+12% so với tháng trước</p>
										</div>
								...
								<Card className='p-6 bg-white border-[#5A3E2B]/10'>
									<div className='flex items-center justify-between'>
										<div>
											...
											<p className='text-sm text-[#A5C6A1]'>+8% so với tháng trước</p>
										</div>
								...
								<Card className='p-6 bg-white border-[#5A3E2B]/10'>
									<div className='flex items-center justify-between'>
										<div>
											...
											<p className='text-sm text-[#A5C6A1]'>+15% so với tháng trước</p>
										</div>
								...
								<Card className='p-6 bg-white border-[#5A3E2B]/10'>
									...
									<ResponsiveContainer width='100%' height={300}>
										<BarChart data={salesData}>
											...
											/>
											<Bar dataKey='revenue' fill='#5A3E2B' radius={[4, 4, 0, 0]} />
										</BarChart>
									</ResponsiveContainer>
								</Card>

								<Card className='p-6 bg-white border-[#5A3E2B]/10'>
									<h3 className='text-lg font-serif text-[#5A3E2B] mb-4'>Phân loại sản phẩm</h3>
									<ResponsiveContainer width='100%' height={300}>
										<PieChart>
											<Pie
							...
							<Card className='p-6 bg-white border-[#5A3E2B]/10'>
								<div className='flex items-center justify-between mb-4'>
									<h3 className='text-lg font-serif text-[#5A3E2B]'>Đơn hàng gần đây</h3>
									<Button
										variant='outline'
										size='sm'
									...
									<table className='w-full'>
										<thead>
											<tr className='border-b border-[#5A3E2B]/10'>
												<th className='text-left py-3 text-[#5A3E2B] font-medium'>Mã đơn hàng</th>
												<th className='text-left py-3 text-[#5A3E2B] font-medium'>Khách hàng</th>
												<th className='text-left py-3 text-[#5A3E2B] font-medium'>Tổng tiền</th>
												<th className='text-left py-3 text-[#5A3E2B] font-medium'>Trạng thái</th>
												<th className='text-left py-3 text-[#5A3E2B] font-medium'>Ngày đặt</th>
											</tr>
										</thead>
										<tbody>
											<tr className='border-b border-[#5A3E2B]/5'>
												<td className='py-3 text-[#5A3E2B] font-mono'>#CM2024001</td>
												<td className='py-3 text-[#5A3E2B]'>Nguyễn Văn A</td>
												<td className='py-3 text-[#5A3E2B] font-medium'>850.000₫</td>
												<td className='py-3'>
													<Badge className='bg-[#87C1D8] text-white'>Đang giao hàng</Badge>
												</td>
												<td className='py-3 text-[#5A3E2B]/70'>20/12/2024</td>
											</tr>
											<tr className='border-b border-[#5A3E2B]/5'>
												<td className='py-3 text-[#5A3E2B] font-mono'>#CM2024002</td>
												<td className='py-3 text-[#5A3E2B]'>Trần Thị B</td>
												<td className='py-3 text-[#5A3E2B] font-medium'>450.000₫</td>
												<td className='py-3'>
													<Badge className='bg-[#A5C6A1] text-white'>Đã giao hàng</Badge>
												</td>
												<td className='py-3 text-[#5A3E2B]/70'>19/12/2024</td>
											</tr>
											<tr className='border-b border-[#5A3E2B]/5'>
												<td className='py-3 text-[#5A3E2B] font-mono'>#CM2024003</td>
												<td className='py-3 text-[#5A3E2B]'>Lê Văn C</td>
												<td className='py-3 text-[#5A3E2B] font-medium'>300.000₫</td>
												<td className='py-3'>
													<Badge className='bg-[#5A3E2B] text-white'>Chờ xử lý</Badge>
												</td>
