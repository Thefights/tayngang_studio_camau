...
export default function OrderDetailPage({}: { params: { id: string } }) {
            ...
            <Card className="p-6 bg-white border-[#5A3E2B]/10">
              ...
              <div className="space-y-4">
                {orderData.items.map((item) => (
                  <div
                    key={item.id}
                    className="flex gap-4 p-4 border border-[#5A3E2B]/10 rounded-lg"
                  >
                    ...
                    <div className="flex-1">
                      <h3 className="font-serif text-[#5A3E2B] font-medium mb-1">
                        {item.name}
                      </h3>
                      <div className="flex items-center justify-between">
                        ...
                        <div className="font-medium text-[#5A3E2B]">
            ...
            <Card className="p-6 bg-white border-[#5A3E2B]/10">
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-[#5A3E2B]">
                    {orderData.tax.toLocaleString("vi-VN")}₫
                  </span>
                </div>
              ...
              <div className="mt-6 pt-6 border-t border-[#5A3E2B]/10">
                <p className="text-sm text-[#5A3E2B]/70 mb-2">
